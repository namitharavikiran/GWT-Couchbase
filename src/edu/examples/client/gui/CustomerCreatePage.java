package edu.examples.client.gui;
	...
	public class CustomerCreatePage extends MyComposite{
		...
		public CustomerCreatePage(MainGUI mainview) {
			initWidget(this.vPanel);
			this.mainview = mainview;
			
			Label titleLbl = new Label(" Enter Customer Details");
			...
			table.setWidget(2, 2, this.lname);
			
			this.email = new TextBox();
			table.setWidget(3, 1, this.email);
		...
		private void saveData() {
			...
			mainview.getListener().createCustomer(cust);
		}
